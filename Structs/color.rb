...
class Color < FFI::Struct
  ...
  PINK = Color.new(255, 109, 194, 255) ; r = Color.new(230, 41, 55, 255)
  MAROON = Color.new(190, 33, 55, 255) ; g = Color.new(0, 228, 48, 255)
  LIME = Color.new(0, 158, 47, 255) ; DARK_g = Color.new(0, 117, 44, 255)
  SKY_b = Color.new(102, 191, 255, 255) ; b = Color.new(0, 121, 241, 255)
  DARK_b = Color.new(0, 82, 172, 255) ; PURPLE = Color.new(200, 122, 255, 255)
